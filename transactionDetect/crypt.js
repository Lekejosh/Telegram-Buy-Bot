  ...
  async getTransaction(callback) {
    try {
      ...
      const buyerTBalance = await axios.get(
        `https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x410e7696dF8Be2a123dF2cf88808c6ddAb2ae2BF&address=${res.data.transactions[0].from}&tag=latest&apikey=112R9MIZ97GI3M7UBVNAR34HYIGEW4RK8W`
      );
